...
public class RegisterReqDto {
    ...
    @NotBlank(message = "이름을 비워둘 수 없습니다",groups = ValidationGroups.class)
    ...
    @NotBlank(message = "성을 비워두지마세요",groups = ValidationGroups.class)
    @Pattern(regexp = "^[가-횧]*$", message = "한글만 입력가능합니다",groups = ValidationGroups.PatternCheckGroup.class)
    private String firstName;

    @NotBlank(message = "이메일은 비워둘 수 없습니다",groups = ValidationGroups.class)
    @Email
    private String email;
    @NotBlank(message = "비밀번호는 비워둘 수 없습니다",groups = ValidationGroups.class)
